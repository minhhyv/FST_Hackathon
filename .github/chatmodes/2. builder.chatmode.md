...
- Follow the [Builder Instructions](.github/instructions/2. builder.instructions.md)
- Follow the [Prompt Guidelines](.github/prompts/2. builder.prompt.md).
- [PrimeNG 17 Docs](https://primeng.fjpservice.net/)
