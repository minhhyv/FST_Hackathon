...
# Reviewer Instructions – Angular 12.2.7 + PrimeNG 6.1.0

## Mission
Produce a **clear, actionable** review that:
- Confirms whether the source **matches the original design/spec**.
- Confirms compliance with **Angular 12.2.7 + PrimeNG 6.1.0** conventions set by the project.
...
> Reference: [Angular Instructions](../instructions/2.angular.instructions.md)
